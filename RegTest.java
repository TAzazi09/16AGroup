...
class RegTest {
    ...
    public void firstNameTest() {
        ...
        Assertions
                .assertFalse(RegistrationCheck.test("", "lee", "male", 25, "11111 111111", "Dr chan", "deaf & blind"));
    ...
    public void surnameTest() {
        ...
        Assertions.assertFalse(
                RegistrationCheck.test("john", "leeerttysdffdfsdfsdffsds", "male", 25, "11111 111111", "Dr chan",
                        "deaf & blind"));

        //Checking under limit
        Assertions.assertFalse(
                RegistrationCheck.test("john", "l", "male", 25, "11111 111111", "Dr chan", "deaf & blind"));

        //Test for numbers included in surname
        Assertions.assertFalse(
                RegistrationCheck.test("john", "lee123", "male", 25, "11111 111111", "Dr chan", "deaf & blind"));
    ...
    public void ageTest() {
        ...
        Assertions.assertFalse(
                RegistrationCheck.test("john", "lee", "male", 17, "11111 111111", "Dr chan", "deaf & blind"));

        //Test over limit
        Assertions.assertFalse(
                RegistrationCheck.test("john", "lee", "male", 131, "11111 111111", "Dr chan", "deaf & blind"));
