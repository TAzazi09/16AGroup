...
public class RegistrationPage extends javax.swing.JFrame {
    ...
    private ArrayList<String> tempDoctorNames;
    ...
    private void initComponents() {
        ...
        try {
            ...
            while (DoctorNameResults.next()) {
                tempDoctorNames.add(DoctorNameResults.getString("Name"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

        String[] DoctorList = new String[tempDoctorNames.size()];
        DoctorList = tempDoctorNames.toArray(DoctorList);

        doctorLabel.setFont(General.font(18));
        doctorList
                .setModel(new javax.swing.DefaultComboBoxModel<>(DoctorList));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(300, 300, 300) // gap between left side of
                                // window and left side of panel
                                                        ...
                                                        layout
                                                                ...
                                                                .addGroup(layout
                                                                        ...
                                                                        .addComponent(phoneInput,
                                                                                ...
                                                                                254,
                                                                                Short.MAX_VALUE)))))
                                .addGap(328, 328, 328))); // I don't know what this gap
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       // is for
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(50, 50, 50) // gap between top of window and top
                                // of panel
                                ...
                                .addComponent(firstnameLabel)
                                .addGap(1, 1, 1) // gap between first name label and
                                // input
                                .addComponent(firstnameInput,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10) // gap between first name input and
                                // surname label
                                ...
                                .addComponent(surnameInput,
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10) // gap between surname input and age
                                // label
                                ...
                                .addComponent(ageInput,
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10) // gap between age input and details
                                // label

                                .addComponent(genderLabel)
                                .addGap(1, 1, 1) // gap between gender label and
                                // checkboxes
                                .addGroup(layout.createParallelGroup(
                                        ...
                                        .addComponent(otherCheck)
                                        .addComponent(pntsCheck))
                                .addGap(10, 10, 10) // gap between checkboxes and phone
                                // label
                                ...
                                .addComponent(phoneInput,
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10) // gap between phone input and
                                // doctor label
                                ...
                                .addComponent(doctorList,
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10) // gap between doctor list and
                                // details label
                                ...
                                .addComponent(jScrollPane1,
                                        ...
                                        111,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20) // gap between details input and
                                // buttons
                                ...
                                .addGroup(layout.createParallelGroup(
                                        ...
                                        .addComponent(regButton,
                                                ...
                                                40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap(191, Short.MAX_VALUE))); // I don't
                                                                                                                                                                                                                                                                                                                                                                                    // know what
                                                                                                                                                                                                                                                                                                                                                                                    // this gap is
                                                                                                                                                                                                                                                                                                                                                                                    // for
    ...
    // Register button - checks if all fields are filled in and sends the data to
    // Registration class for further processing
    // Also checks if there are any errors in the data that may result in an SQL
    // error due to our database constraints
    private void Register_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        if (firstnameInput == null) {
            ...
            boolean outcome = RegistrationCheck.test(firstnameInput.getText(), surnameInput.getText(),
                    selection,
